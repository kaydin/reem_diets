...
# Predprey queries
reem.download.bts.predprey(channel, region="BS",  path="data/local_reem_data") 
...
# Prey length query
reem.download.bts.preylenths(channel, region="BS",  path="data/local_reem_data")
...
#       data/combined_BTS_strata.csv is hand-made

# note query.to.data does not create directories - may need to fix that
