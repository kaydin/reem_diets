...
#combine final biomass table with other Strata info file and Model Species List_GAP_Biomass.csv file (species names)  
 ...
 Biomass_Strata_noLbin_EGOA.B<-final_table2 %>%
...
write.csv(Biomass_Strata_noLbin_EGOA.B,"C:/Users/Bridget.Ferriss/Work/Rpath/GOA_Rpath_git/GOA_Rpath/GOA_biomass/results/Biomass_Stratum_noLbin_EGOA.B.csv",row.names=F) 
head(Biomass_Strata_noLbin_EGOA.B)
